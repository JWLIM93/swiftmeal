...
function submitRegister() {
    ...
    var repassword =
        document.forms['registerationForm']['retypePassword'].value;
    ...
    if (
        ...
        document.getElementById('password_error_msg').innerHTML =
            'your password should be at least 8 character long!';
        ...
        document.getElementById('confirm_password_error_msg').innerHTML =
            'your passwords is not the same!';
        document.registerationForm.retypePassword.focus();
        ...
        document.getElementById('phone_error_msg').innerHTML =
            'There should not be any letters in your phone number!';
